...
readf :: proc{readf_short, readf_int, readf_float, readf_double}
writef :: proc{writef_short, writef_int, writef_float, writef_double}
read :: proc{read_short, read_int, read_float, read_double}
write :: proc{write_short, write_int, write_float, write_double}
